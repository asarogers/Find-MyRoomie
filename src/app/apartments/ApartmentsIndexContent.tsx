...
export default function ApartmentsIndexContent() {
      ...
      <main className="min-h-screen bg-[#FDFBF7] text-gray-900">
        ...
        <section className="py-6 px-4 bg-blue-50 border-b border-blue-100">
          <div className="max-w-3xl mx-auto flex flex-wrap items-center gap-4">
            <div>
              <span className="font-bold text-blue-900">SF Rent Price Tracker — March 2026:</span>
              <span className="text-blue-700 ml-2">Median 1BR $3,565 · +11.8% YoY · 15 neighborhoods with monthly data</span>
            </div>
            <Link href="/data/sf-rent-prices/" className="text-sm font-bold text-blue-700 underline underline-offset-2 hover:text-blue-900 whitespace-nowrap">
              View full tracker →
            </Link>
          </div>
        </section>
