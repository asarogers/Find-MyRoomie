...
const RELATED = [
  { slug: 'miro-san-jose', name: 'Miro San Jose', desc: 'Downtown comparison. Near Diridon Station.' },
  { slug: 'the-fay-san-jose', name: 'The Fay San Jose', desc: 'Local feel. Downtown San Jose option.' },
