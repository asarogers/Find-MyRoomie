...
const RELATED = [
  ...
  { slug: 'neo-on-first-san-jose', name: 'Neo on First San Jose', desc: 'S. First Street downtown comparison.' },
  { slug: 'san-jose-ca', name: 'San Jose City Guide', desc: 'Full San Jose roommate market overview.' },
